...
export default function OffersPage() {
  ...
  useEffect(() => {
    async function fetchOffersAndBusinesses() {
      setLoading(true);
      try {
        // Φόρτωσε όλες τις προσφορές (χωρίς orderBy γιατί δεν το χρειάζεσαι)
        ...
        // Βρες μοναδικές κατηγορίες από τις επιχειρήσεις που έχουν προσφορές
        ...
        // Φιλτράρισμα βάση επιλεγμένης κατηγορίας
        if (filterCategory) {
          data = data.filter((offer) => {
            const bizCat = businessesMap[offer.businessId]?.businessCategory;
  ...
  return (
    <>
      ...
      <div style={{ maxWidth: 700, margin: "40px auto", padding: 16 }}>
        ...
        {/* Φίλτρο κατηγορίας */}
        <div style={{ marginBottom: 20, minWidth: 180 }}>
          <label
            htmlFor="categoryFilter"
            style={{ fontWeight: "600", fontSize: 16, marginBottom: 6, display: "block" }}
          >

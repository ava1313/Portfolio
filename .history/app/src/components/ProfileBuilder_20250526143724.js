...
import PopupModal from "./PopupModal"; // Import popup modal
...
export default function ProfileBuilder() {
  ...
  const [modalMessage, setModalMessage] = useState(""); // For popup modal message
  ...
  useEffect(() => {
    if (role === "client") {
      ...
      const requiredBusinessFields = [
        ...
        "companyDescription",
        "keywords",
        "googleMapsUrl", // make googleMapsUrl required too
      ];
      setIsValid(
            ...
            <>
              ...
              <label>
                ...
                <input
                  ...
                  type="url"
                  onChange={(e) =>
                    setForm((prev) => ({ ...prev, googleMapsUrl: e.target.value.trim() }))
                  }

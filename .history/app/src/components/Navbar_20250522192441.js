...
export default function Navbar() {
  ...
  const [modalType, setModalType] = useState(null); // "offers" or "events"
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.description.trim())
      return alert("Παρακαλώ συμπληρώστε την περιγραφή.");
    ...
    try {
      ...
      console.error("Error creating document:", err.code, err.message);

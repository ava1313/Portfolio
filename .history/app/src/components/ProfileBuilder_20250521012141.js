...
import categoriesData from "../data/categories"; // Your categories data file
...
// Flatten categories + subcategories for autocomplete suggestions
...
export default function ProfileBuilder() {
  ...
  // Input change handler including category autocomplete
  const onChange = (e) => {
  ...
  // Form submit: saves profile to Firestore

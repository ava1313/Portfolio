...
export default function MainPage() {
  ...
  // Handle category autocomplete suggestions
  useEffect(() => {
  ...
  // Location autocomplete load & change handlers
  ...
  const onSearch = () => {
    // For now just alert the search terms
    alert(
      `Searching with:\nCategory: ${searchTerm}\nLocation: ${location}\nKeyword: ${keyword}`
    );
    // Here you would call your search API or navigate with query params etc.
  };

...
export default function ResultsPage() {
  ...
  style={{
    ...
    justifyContent: "center",
    alignItems: "center",
    overflowX: "auto"  // optional: allow horizontal scroll on very small screens
  }}
>
  <select
  ...
  <div style={{ flexGrow: 1, minWidth: 350, maxWidth: 450, marginRight: 8 }}>
    {isLoaded ? (

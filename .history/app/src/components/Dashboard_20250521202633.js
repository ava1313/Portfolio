...
import { auth, db, storage } from "../firebase";  // single import of initialized Firebase objects
import {
  updateEmail,
...
export default function Dashboard() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      let photoURL = userData.profile?.photoURL || null;
      if (imageFile) {
      ...
      // Update Firestore profile with form data + photoURL
      const userRef = doc(db, "users", user.uid);
      await updateDoc(userRef, {
        profile: { ...formData, photoURL },
      });
            ...
            <section style={{ marginTop: 20 }}>
              ...
              >
                ...
                <div style={{ textAlign: "center", marginBottom: 20 }}>
                  <img
                    src={imagePreview || profile?.photoURL || "/placeholder-logo.png"}
                    alt="Profile"

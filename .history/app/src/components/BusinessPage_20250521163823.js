...
import { useGoogleMaps } from "./GoogleMapsLoader"; // Your Google Maps context hook
import "./style.css";
...
export default function BusinessPage() {
  ...
  // Fetch Google reviews using PlacesService when Google API is loaded and business info available
  useEffect(() => {
    if (
      isLoaded &&
      biz &&
      ...
      console.log("Google Places textSearch query:", queryString);

      service.textSearch(
        { query: queryString },
        (results, status) => {
          console.log("Google Places textSearch status:", status, results);
          if (
            ...
            service.getDetails(
              ...
              (placeDetails, detailStatus) => {
                console.log("Google Places getDetails status:", detailStatus, placeDetails);
                if (

...
import { useGoogleMaps } from "./GoogleMapsLoader"; // your context hook for maps
import categoriesData from "../data/categories"; // your categories JSON
...
// Flatten categories and subcategories for suggestions
...
export default function ProfileBuilder() {
  ...
  const onChange = (e) => {
    ...
    if (name === "businessCategory") {
      ...
      if (value.length > 0) {
        // Filter suggestions case-insensitive and limit to 5
